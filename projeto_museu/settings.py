"""
Django settings for projeto_museu project.
...
SECRET_KEY = 'django-insecure-##4_j_p91fei^%6hy5g@m47e-406-f^&mo)-ru(fw&@39et7mr'
...
INSTALLED_APPS = [
    ...
    'base', # linha adicionando o app criado
]
...
# Diretório de destino para `collectstatic` (apenas em produção)
